  ...
  return (
    <div className="flex flex-col md:flex-row flex-wrap  rounded-lg px-6 md:px-10 lg:px-20">
      ...
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
        ...
        <Link
          to="#speciality"
          className="flex items-center gap-2 bg-slate-500 px-8 py-3 rounded-full text-white text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300"
        >
          Book Appointment{" "}
      ...
      {/* ------- Right Side ------- */}
      <div className="md:w-1/2 relative bg-white rounded-lg">
        <img
          className="w-full md:absolute h-[470px] bottom-0  rounded-[50%] bg-white "
          src={assets.group_Doctor}
          alt=""
        />
      </div>
    </div>
